 ...
 */
export type AgentRole = 'tool_orchestrator' | 'javascript_specialist' | 'python_specialist' | 'tauri_specialist' | 'pipeline_specialist' | 'integration_analyst' | 'repair_specialist';
